                         ...
                         <div class="form-group mt-4">
                            ...
                            <ul class="nav nav-tabs" id="targetingTabs" role="tablist" style="border: none; ">
                                <li class="nav-item" role="presentation" >
                                    <a class="nav-link active" id="none-tab" style="borer: 2px solid green !important;" data-bs-toggle="tab" href="#none" role="tab" aria-controls="none" aria-selected="true">None</a>
                                </li>
                                <li class="nav-item" role="presentation">
