...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare(
        "INSERT INTO sms_link (
            user_id,
            link_name, short_code, reciever, message
        ) VALUES (?, ?, ?, ?, ?)"
    );
    ...
    $url = $rooturl."/".$short_code;    // Replace with your domain
                         ...
                         <table class="table table-hover">
                            ...
                            <tbody>
                                <!-- Example Row (Repeat for each link in your database) -->
                                    ...
                                    <td class="text-center"><a href="<?php echo htmlspecialchars($baseUrl . 'links/shortcode_handler.php?shortcode=' . $sms_short_code); ?>" target="_blank"><?php echo $_SERVER['HTTP_HOST']?>/<?php echo $short_code ?></a></td>
                                    <td class="text-center"><?php echo $reciever?></td>
                                    <td class="text-center"><?php echo $message_body?></td>
