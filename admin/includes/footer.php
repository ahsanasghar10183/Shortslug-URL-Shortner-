            ...
            <div class="row">
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="footer-logo-col">
                        <a href="#"><img src="./assets/images/footer/retina-logo.png" style="width: 50%; height:50%;"></a>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="subscribe">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-info btn-hover-secondery ms-xxl-2 ms-xl-2 ls-lg-0 ms-md-0 ms-sm-0 ms-0"  type="button" id="button-addon2">Register</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="copyrights text-center blue-light  fw-500">@<span id="autodate">2023</span> - All Rights Reserved  <a href="https://adminmart.com/" class="blue-light text-decoration-none">Shortslug.com</a> Developed By <a href="#" class="blue-light text-decoration-none">Ahsan Asghar</a></div>
        </div>
    </footer>
    <!------------------------------>
    <!-------Footer End------------->
