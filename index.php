...
<body>
            ...
            <div class="row d-flex flex-wrap align-items-center">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="position-relative left-hero-color">
                        ...
                        <p>The Link management tool you love.</p>
                        <div class=" mt-5">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="position-relative right-hero-color d-flex">
                        <img src="./assets/images/analytics-hero-image.png " class="img-fluid m-auto"> 
                    </div>          
                </div>
            </div>
        </div>
    ...
    <section class="service position-relative overflow-hidden">
        <div class="container position-relative">
            ...
            <div class="row">
                <div class="col-12"><small class="fs-7 d-block">Workflow</small></div>
                <div class="col-12 d-xxl-flex d-xl-flex d-lg-flex d-md-flex d-sm-block d-block align-items-center justify-content-xxl-between justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-between justify-content-sm-center ">
                    <h2 class="fs-2 text-black mb-0">How Shortslug<br> Works</h2>
                    <a href="#" class="btn btn-primary btn-hover-secondery section-btn">Try For Free</a>
                </div>
            </div>
            <div class="row d-flex flex-wrap justify-content-center step-row">
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 text-center">
                    <div class="card border-0 shadow">
                        <div class="card-body">
                            ...
                            <h3 class="fs-4">Create Free Account</h3>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 text-center">
                    <div class="card border-0 shadow">
                        <div class="card-body">
                            <div class="icon-round overflow-hidden rounded-circle position-relative d-flex align-items-center justify-content-center mx-auto text-center">
                            <i class="ti ti-link text-primary position-relative"></i>  
                          </div>
                            <h5 class="mb-0 fw-500">Step 2</h5>
                            <h3 class="fs-4">Process Links</h3>
                            <p class="fs-7 mb-0 fw-500">There are many variations of pass for ages of oremsum.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 text-center">
                    <div class="card border-0 shadow">
                        <div class="card-body">
                            <div class="icon-round overflow-hidden rounded-circle position-relative d-flex align-items-center justify-content-center mx-auto text-center">
                                <i class="ti ti-device-analytics text-primary position-relative"></i>
                            </div>
                            <h5 class="mb-0 fw-500">Step 3</h5>
                            <h3 class="fs-4">Manage Links</h3>
                            <p class="fs-7 mb-0 fw-500">There are many variations of pass for ages of oremsum.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="our-service position-relative overflow-hidden">
        <div class="container">
            ...
            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ps-xxl-0 ps-xl-0 ps-lg-3 ps-md-3 ps-sm-3 ps-3">
                    ...
                    <small class="fs-7 d-block">Product Features</small>
                    <h2 class="fs-2 text-black mb-0">Explore 20 + Features</h2>
                ...
                <div class="features-container">
                    <div class="d-flex flex-wrap justify-content-center">
                      <div class="feature-item">HTTP & HTTPS Secure Links</div>
                      <div class="feature-item">QR Codes with Dynamic Destinations</div>
                      <div class="feature-item">Expiring Links</div>
                      <div class="feature-item">Chrome & Firefox Browser Plugins</div>
                      <div class="feature-item">Redirect by Country</div>
                      <div class="feature-item">Redirect by Device</div>
                      <div class="feature-item">Link Cloaking & Disguising</div>
                      <div class="feature-item">Custom URL Shortener</div>
                      <div class="feature-item">Bulk Import Links</div>
                      <div class="feature-item">Team Collaboration</div>
                      <div class="feature-item">Real-Time Analytics</div>
                      <div class="feature-item">Predictive Insights</div>
                      <div class="feature-item">Privacy-Focused Links</div>
                      <div class="feature-item">Triggered Link Redirection</div>
                      <div class="feature-item">Link Aggregation</div>
                      <div class="feature-item">No-Code Landing Pages</div>
                      <div class="feature-item">Password Protection</div>
                      <div class="feature-item">Social Sharing Integration</div>
                      <div class="feature-item">Multi-Language Support</div>
                      <div class="feature-item">Track mailto, tel, & sms Links</div>
                    </div>
