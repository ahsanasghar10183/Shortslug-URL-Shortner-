<header class="main-header position-fixed w-100">
            <div class="container">
                <nav class="navbar navbar-expand-xl py-0">
                    <div class="logo">
                        <a class="navbar-brand py-0 me-0" href="#"><img src="./assets/images/short-slug-logo.png" class="logo_image" alt=""></a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">                                             
                            ...
                            <div class="d-flex align-items-center">
                              <a class="btn btn-outline-primary  text-capitalize " href="#">Login</a>
                                
                                <a class="btn btn-primary btn-hover-secondery text-capitalize px-3 py-3" href="#">Get Started</a>
                            </div>
                    </div>
                </nav>
            </div>
